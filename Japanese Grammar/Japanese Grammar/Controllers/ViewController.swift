...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    let arrayWords : [String] = Grammars.sharedDataSources.datasourceGrammars()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.wordLabel.text = arrayWords[indexPath.row].components(separatedBy: "\n")[0]
        cell.exampleLabel.text = arrayWords[indexPath.row].components(separatedBy: "\n")[1]
